...
Snoop: поиск никнейма по всем фронтам! (Version :: Сборка 1.2.9D_rus Snoop Demo for termux)
...
optional arguments:
  ...
  --web-base, -w        Подключиться для поиска 'username' к
                        ...
                        отключена
  --site , -s           Указать имя сайта из БД '--list all'. Поиск
  ...
  --userload , -u       Указать файл со списком user-ов.
                        ...
                        start' Пример для Windows: 'python snoop.py -u
  ...
  --normal, -N          Переключатель режимов: SNOOPninja >
                        ...
                        Version. По_умолчанию (Windows) вкл 'нормальный
                        режим'. В Demo Version переключатель режимов
                        деактивирован
  --module y, -m y      OSINT поиск: используя различные плагины
                        Snoop (список плагинов будет пополняться)
